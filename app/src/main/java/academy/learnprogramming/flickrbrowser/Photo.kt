...
class Photo(
    ...
    /* Serializable purpose is to break objects and data down into a bytestream which is data format
    * more suited for storing and being transferred over a network
    * */
